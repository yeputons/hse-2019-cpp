...
* Базовые
  ...
  * Инициализация:
    ...
    * Добавить в агрегат конструкторы, при этом сохранить старый синтаксис из-за uniform initialization. Где-то надо, а где-то не надо принимать вложенный `initializer_list`.
  * Касты
