...
# Исключения
## Исключения в пользовательском конструкторе

## Исключение при создании подобъектов

## Исключения в деструкторах

## Strong guarantee, copy-and-swap

## Иногда исключения запрещают целиком: сложно упомнить, что везде нужно RAII

## Тонкости, где исключения всё ещё работают
Не удалось выделить память
Конструктор в `new` выбросил исключение
Конструктор в `new[]` выбросил исключение
